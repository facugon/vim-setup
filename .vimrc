...
set incsearch
set showmatch
" Permite recorrer la pantalla con el cursor sin parar en el fin de linea, los tabs, etc.
"set virtualedit=all
set nobackup
set nowritebackup
set background=dark
...
set pastetoggle=<F2>
" Un color para la sintaxis alternativo
"colorscheme greens
" El que usamos siempre
"colorscheme ron
...
" para poner color sobre la linea actual. medio molesto para codear
"set cursorline  
...
"    highlight DiffText cterm=none ctermfg=bg ctermbg=Magenta gui=none guifg=bg guibg=Magenta 
    ...
    highlight DiffDelete ctermfg=bg ctermbg=darkcyan
    highlight DiffChange cterm=none ctermfg=black ctermbg=darkgreen
    highlight DiffText cterm=none ctermfg=bg ctermbg=darkred
endif
